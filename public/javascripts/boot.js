...
formAction.creditcardField = function(){
  ...
  $('.cc-number').on('keyup', function(){
    ...
    if (cardtype){
      ...
      $(this).css("background-image", 'url("images/card_'+ cardtype +'.png")');
    }
  ...
  $('.cc-csc').on("focus focusout", function(){
    ...
    trigger: "manual",
    title: "記載場所",
    content: (($("#cc_number").attr("data-cardtype") == "amex") ? '<img src="./images/securitycode_amex.png" width="185" height="126" style="max-width: 100%;"><p>セキュリティコードはカード表面の番号右上に記載の数字4桁になります</p>' : '<img src="./images/securitycode_visa.png" width="185" height="126" style="max-width: 100%;"><p>セキュリティコードはカード裏面の署名欄に記載の数字末尾3桁になります</p>')
    }).popover("toggle");
  });
